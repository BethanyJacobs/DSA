...
$data = array("method"=>"flickr.photos.search","api_key"=>"dc1f9eb346b25a1291c4970b6d0942c5","lat"=>"-22.9510","per_page"=>"10","radius"=>"1","geo_context"=>"2","radius_units"=>"mi","lon"=>"-43.2065","format"=>"json","nojsoncallback"=>"1");
$ch = curl_init();
